...
class GameOrchestratorNode(Node):
    ...
    def __init__(self):
        ...
        self.wall_pose = [
            [233.034, -137.454, 55.061, 148.394, 179.928, -121.78],
            [232.998, -77.359, 55.039, 148.814, 179.924, -121.369],
            [232.963, -17.258, 55.027, 148.992, 179.923, -121.209],
            [231.999, 42.815, 55.024, 150.607, 179.921, -119.603],
            [231.01, 102.933, 55.014, 152.954, 179.919, -117.273],
            [230.446, 162.316, 55.292, 123.353, 179.93, -146.878]
        ] # task
