...
class CleanUpNode(Node):
    ...
    def __init__(self):
        ...
        self.AI_wall_init_pose = [
            [227.034, -137.454, 54.061, 148.394, 179.928, -121.78],
            [226.998, -77.359, 54.039, 148.814, 179.924, -121.369],
            [226.963, -17.258, 54.027, 148.992, 179.923, -121.209],
            [226.999, 42.815, 54.024, 150.607, 179.921, -119.603],
            [226.01, 102.933, 54.014, 152.954, 179.919, -117.273],
            [225.446, 162.316, 54.292, 123.353, 179.93, -146.878]
        ]
